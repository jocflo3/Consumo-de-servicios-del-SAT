...
{
    public class SatSolicitudMasivoBuilder
    {
        private readonly SatSoapBuilder _soapBuilder;

        public SatSolicitudMasivoBuilder()
        {
            _soapBuilder = new SatSoapBuilder();
        }
        //public string GenerarXmlAutenticacion(X509Certificate2 cert, ConfigSolicitudMasivoDTO sol)
        //{
