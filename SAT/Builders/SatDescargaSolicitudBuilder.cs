...
{
    public class SatDescargaSolicitudBuilder
    {
        private readonly SatSoapBuilder _soapBuilder;

        public SatDescargaSolicitudBuilder()
        {
            _soapBuilder = new SatSoapBuilder();
        }
        public string GenerarXmlDescargaSolicitud(X509Certificate2 cert, string idPaquete, string rfcSolicitante)
        {
            ...
            XmlElement verificaSolicitud = doc.CreateElement("des", "PeticionDescargaMasivaTercerosEntrada", SatNamEspaces.DescargaMasiva);
            ...
            XmlElement solicitud = doc.CreateElement("des", "peticionDescarga", SatNamEspaces.DescargaMasiva);
            solicitud.SetAttribute("IdPaquete", idPaquete);
